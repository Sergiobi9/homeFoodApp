...
import 'package:home_food_project/ui/food/register/register_food_supermarkets_available.dart';
import 'package:home_food_project/utils/utils.dart';
import 'package:image_picker/image_picker.dart';
import 'package:image_cropper/image_cropper.dart';

class RegisterFoodImage extends StatefulWidget {
  @override
  RegisterFoodImageImplementation createState() =>
      RegisterFoodImageImplementation();
}

class RegisterFoodImageImplementation extends State<RegisterFoodImage> {
  ...
  void nextStep(context) {
    RegistrerFood.imageFile = imageFile;
    Utils.navigateToNewScreen(context, RegisterFoodSupermarketsAvailablePage());
  }
